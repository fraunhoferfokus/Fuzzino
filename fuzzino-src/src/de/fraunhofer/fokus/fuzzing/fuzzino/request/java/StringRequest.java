...
/**
 * A StringRequest opens a request for a string to be fuzzed by the library. It 
 ...
 *
 */
public interface StringRequest extends CommonRequest {

	/**
	 * @return The {@link StringSpecification} of this string request.
	 */
	StringSpecification getSpecification();
	
	/**
	 * Sets the {@link StringSpecification} of this string request.
	 * 
	 * @param value the {@link StringSpecification} to be set.
	 */
	void setSpecification(StringSpecification value);
	 ...
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.StringRequest}.
	 * 
	 * @param emfStringRequest the EMF string request whose values shall be transferred to this request.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.StringRequest emfStringRequest);
