...
public interface CollectionRequest extends CommonRequest {
	 ...
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.CollectionRequest}.
	 * 
	 * @param emfCollectionRequest the EMF collection request whose values shall be transferred to this request.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.CollectionRequest emfCollectionRequest);
