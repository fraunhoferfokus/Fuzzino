...
public interface ValidCollectionsSection extends Serializable {
	...
	/**
	 * Initializes this object with the values of the corresponding object of the EMF class
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.ValidCollections}.
	 * 
	 * @param emfValidCollections The EMF valid collections instance whose values shall be transferred
	 *                            to this one.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.ValidCollections emfValidCollections);
