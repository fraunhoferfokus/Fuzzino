...
public interface ValidCollection extends Serializable {
	...
	/**
	 * Initializes this valid collection with the values of the corresponding object of the EMF class
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.ValidCollection}.
	 * 
	 * @param emfValidCollection The EMF valid collection instance whose values shall be transferred
	 *                            to this one.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.ValidCollection emfValidCollection);
