 ...
 * <ul>
 *   <li>{@link de.fraunhofer.fokus.fuzzing.fuzzino.request.impl.GeneratorImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.fraunhofer.fokus.fuzzing.fuzzino.request.impl.GeneratorImpl#getParam <em>Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneratorImpl extends EObjectImpl implements Generator {
	...
	protected EClass eStaticClass() {
		return RequestPackage.Literals.GENERATOR;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequestPackage.GENERATOR__VALUE, oldValue, value));
	}
	...
	public void setParam(String newParam) {
		...
		param = newParam;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequestPackage.GENERATOR__PARAM, oldParam, param));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RequestPackage.GENERATOR__VALUE:
				return getValue();
			case RequestPackage.GENERATOR__PARAM:
				return getParam();
		}
