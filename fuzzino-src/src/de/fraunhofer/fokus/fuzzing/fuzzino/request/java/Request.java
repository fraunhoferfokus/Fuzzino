...
public interface Request extends Serializable {
	 ...
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.Request} that is returned when loading
	 * an XML file.
	 * 
	 * @param emfRequest the EMF request whose values shall be transferred to this request.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.Request emfRequest);
	
	/**
	 * @return {@code true} if this request was initialized using 
	 * {@link #setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.Request)}.
	 */
	boolean isEMFBased();
