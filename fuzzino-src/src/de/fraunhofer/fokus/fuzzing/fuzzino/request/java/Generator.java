...
public interface Generator extends Serializable {
	...
	/**
	 * Initializes this generator with the values of the corresponding object of the EMF class
	 * {@link de.fraunhofer.fokus.fuzzing.fuzzino.request.Generator}.
	 * 
	 * @param emfGenerator The EMF generator whose values shall be transferred to this generator.
	 */
	void setWithEMFObject(de.fraunhofer.fokus.fuzzing.fuzzino.request.Generator emfGenerator);
