...
public class FuzzedCollectionImpl implements FuzzedCollection {
	...
	public void initWithValidCollection(ValidCollection validCollection) {
		FuzzedCollection fuzzedCollection = de.fraunhofer.fokus.fuzzing.fuzzino.response.ResponseFactory.INSTANCE.createFuzzedCollection();
		for (String validValue : validCollection.getValues()) {
			Value value = de.fraunhofer.fokus.fuzzing.fuzzino.response.ResponseFactory.INSTANCE.createValue();
