...
public class BadLongStringsGenerator extends ComposedStringGenerator {
	...
	private void initHeuristics() {
		...
		BigIntFromRangesAsString bigIntRanges = new BigIntFromRangesAsString(stringSpec, owner, seed,
		...
		heuristics.add(new ConcreteValuesGenerator(stringSpec, seed, owner, "\\x00\\x00" + StringUtil.repeat("A", 7000),
